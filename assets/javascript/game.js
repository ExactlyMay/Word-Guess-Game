    ...
    document.onkeyup = function(event) {
        ...
        userInput === 'y' || userInput === 'z'){
            ...
            if (gameAnswer === gameAnswerArray.join(""))
            {
                ...
                switch(gameAnswer) {
                    case "tuvok":
                        photoDiv.innerHTML = "<img src='assets/images/tuvok.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Tuvok</h2>";
                        tuvokAudio.play();
                        break;
                    case "janeway":
                        photoDiv.innerHTML = "<img src='assets/images/janeway.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Janeway</h2>";
                        janewayAudio.play();
                        break;
                    case "seven":
                        photoDiv.innerHTML = "<img src='assets/images/seven.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Seven</h2>";
                        sevenAudio.play();
                        break;
                    case "chakotay":
                        photoDiv.innerHTML = "<img src='assets/images/chakotay.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Chakotay</h2>";
                        chakotayAudio.play();
                        break;
                    case "neelix":
                        photoDiv.innerHTML = "<img src='assets/images/neelix.jpg' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Neelix</h2>";
                        neelixAudio.play();
                        break;
                    case "doctor":
                        photoDiv.innerHTML = "<img src='assets/images/doctor.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Doctor</h2>";
                        doctorAudio.play();
                        break;
                    case "kes":
                        photoDiv.innerHTML = "<img src='assets/images/kes.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Kes</h2>";
                        kesAudio.play();
                        break;
                    case "torres":
                        photoDiv.innerHTML = "<img src='assets/images/torres.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Torres</h2>";
                        torresAudio.play();
                        break;
                    case "paris":
                        photoDiv.innerHTML = "<img src='assets/images/paris.gif' class='rounded mx-auto d-block' class='img-fluid' style='width: 280px; height: 280px'>"
                        + "<h2>Paris</h2>";
                        parisAudio.play();
                        break;
                }
